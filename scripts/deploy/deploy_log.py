...
version log. Deploys for new in-progress git refs record the current APP_VERSION
instead of requiring a pre-existing exact-ref version row.
"""
...
def require_version_record_for_deploy(
    *,
    ...
    """Retained deploy preflight hook; deploys may record new git refs."""
    return
